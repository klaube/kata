...
public class StringRegexCalculatorTest {


	private StringRegexCalculator undertest;

	@Before
	public void setUp() throws Exception {
		undertest = new StringRegexCalculator();
	}
	...
	public void negative_numbers_are_not_allowed() {
		try {
			undertest.validate("-1,-12");
			fail("NegativeNumberException should be thrown!");
		} catch (NegativeNumberException e) {
			List<Integer> negativeNumbers = e.getNegativeNumbers();
			assertThat(negativeNumbers, hasSize(2));
			assertThat(negativeNumbers, contains(new Integer(-1), new Integer(-12)));
		}
	}
